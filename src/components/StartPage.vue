...
<template>
    <div class="ps-5 pt-3 pe-4">
        ...
        <div class="d-flex align-items-center mu mt-4 p-3">
            <img src="https://cdn-icons-png.flaticon.com/512/215/215874.png" alt="home" width="40" height="40" />
            <div class="ps-2 menu">
                หน้าหลัก
            </div>
        </div>
        <div class="d-flex align-items-center mu mt-4 p-3">
            <img src="https://cdn-icons-png.flaticon.com/128/3778/3778766.png" alt="user" width="40" height="40" />
            <div class="ps-2 menu">
                ข้อมูลส่วนตัว
            </div>
        </div>
        <div class="d-flex align-items-center mu mt-4 p-3">
            <img src="https://cdn-icons-png.flaticon.com/512/3915/3915582.png" alt="add more" width="40"
                height="40" />
            <div class="ps-2 menu">
                เพิ่มเติม
            </div>
        ...
        <div class="position-absolute bottom-0 start-0 ms-5 my-5">
            <div class="container profile d-flex align-items-center">
                <div class="row align-items-center justify-content-center">
                    <div class="col">
                        <img src="https://cdn-icons-png.flaticon.com/128/9004/9004904.png" alt="demo" width="60"
                            height="60" />
                    </div>
                    <div class="col">
                        {{ usm }}
